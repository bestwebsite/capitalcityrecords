 ...
 */
/* jshint -W062 */
/* global Event, SnakepitUi, SnakepitParams */
var SnakepitCarousels = function( $ ) {
	...
	return {
		...
		moduleCarousel : function () {
			...
			if ( SnakepitUi.isMobile ) {
				return;
			}
			
			$( '.module-carousel' ).each( function() {

				if ( $( this ).find( '.entry' ).length < parseInt( SnakepitParams.relatedProductCount, 10 ) + 1 ) {
					return;
				}
