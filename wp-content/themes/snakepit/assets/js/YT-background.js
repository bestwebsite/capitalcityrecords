...
var SnakepitYTVideoBg = function( $ ) {
		...
		init : function ( $container ) {
			...
			setTimeout( function() {
				...
				if ( typeof window.onYouTubePlayerAPIReady !== 'undefined' ) {
					if ( typeof window.SnakepitOtherYTAPIReady === 'undefined' ) {
						window.SnakepitOtherYTAPIReady = [];
					}
					window.SnakepitOtherYTAPIReady.push( window.onYouTubePlayerAPIReady );
				}
				...
				window.onYouTubePlayerAPIReady = function() {
					...
					if ( typeof window.SnakepitOtherYTAPIReady !== 'undefined' ) {
						if ( window.SnakepitOtherYTAPIReady.length ) {
							window.SnakepitOtherYTAPIReady.pop()();
						}
					}
				};
			}, 2 );
