...
;( function( $ ) {
	 ...
	 * Background
	 */
	var colorSchemeStyle = $( '#snakepit-color-scheme-css' ),
		fontsStyle = $( '#snakepit-fonts-css' ),
		layoutStyle = $( '#snakepit-layout-css' ),
		api = wp.customize,
		backgrounds = {
	...
	if ( ! colorSchemeStyle.length ) {
		colorSchemeStyle = $( 'head' ).append( '<style type="text/css" id="snakepit-color-scheme-css" />' )
			.find( '#snakepit-color-scheme-css' );
	}

	// Fonts style tag
	if ( ! fontsStyle.length ) {
		fontsStyle = $( 'head' ).append( '<style type="text/css" id="snakepit-fonts-css" />' )
			.find( '#snakepit-fonts-css' );
	}

	// Layout style tag
	if ( ! layoutStyle.length ) {
		layoutStyle = $( 'head' ).append( '<style type="text/css" id="snakepit-layout-css" />' )
			.find( '#snakepit-layout-css' );
	}
	...
	api( 'menu_width', function( value ) {
		value.bind( function( to ) {
			...
			SnakepitUi.centeredLogoOffset();
			SnakepitUi.subMenuDirection();
		} );
	} );
	...
	api( 'footer_type', function( value ) {
		value.bind( function( to ) {
			...
			SnakepitUi.footerPageMarginBottom();
		} );
	} );
