<?php
/**
 * Snakepit customizer colors preview functions
 *
 * @package WordPress
 * @subpackage Snakepit
 * @version 1.2.7
...
/**
 * Registers color schemes for Snakepit.
 *
 * Can be filtered with {@see 'snakepit_color_schemes'}.
 *
 ...
 */
function snakepit_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Snakepit.
	 *
	 ...
	 * }
	 */
	return apply_filters( 'snakepit_color_schemes', [

		'default' => [
			'label'  => esc_html__( 'Default', 'snakepit' ),
			'colors' => [
				'#ffffff', // body_bg
				'#ffffff', // page_bg
 ...
 */
function snakepit_get_color_scheme_css( $colors ) {
	...
	***********************/
	...
	return apply_filters( 'snakepit_color_scheme_output', $output, $colors );
}
 ...
 * @return array $colors
 */
function snakepit_get_template_colors() {
 ...
 * Customizer preview.
 */
function snakepit_color_scheme_css_template() {

	$colors = snakepit_get_template_colors();
	?>
	<script type="text/html" id="tmpl-snakepit-color-scheme">
		<?php echo snakepit_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'snakepit_color_scheme_css_template' );
