...
<section class="author-box-container author-hero">
	<div class="author-box clearfix">
		<div class="author-avatar">
			<?php echo get_avatar( get_the_author_meta( 'user_email', $author_id ), apply_filters( 'snakepit_author_heading_avatar_size', 80 ) ); ?>
		</div><!-- .author-avatar -->
		...
		<div class="author-description" itemprop="author" itemscope itemtype="https://schema.org/Person">
			...
			<p class="author-socials">
				<?php snakepit_author_socials( $author_id ); ?>
			</p>
