...
<li <?php snakepit_post_attr(); ?>>
	...
	<span class="event-table-cell event-location">
		...
		<?php endif; ?>
		<span class="location"><?php echo sanitize_text_field( $display_location ); ?></span>
	</span>
	<span class="event-table-cell event-venue" itemprop="location" itemscope itemtype="https://schema.org/<?php echo apply_filters( 'snakepit_microdata_event_itemtype_venue', 'MusicVenue' ) ?>">
		<?php if ( $do_link ) : ?>
			<a rel="bookmark" class="event-link-mask" href="<?php the_permalink(); ?>"></a>
		<?php endif; ?>
		...
		<span class="venue" itemprop="name"><?php echo sanitize_text_field( $venue ); ?></span>
	</span><!-- .event-location -->
