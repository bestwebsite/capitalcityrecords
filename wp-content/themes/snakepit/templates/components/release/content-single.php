 ...
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php snakepit_post_attr(); ?>>
	...
	<div class="release-info-container clearfix">
			...
			<a class="lightbox" href="<?php echo get_the_post_thumbnail_url( '', '%SLUG-XL%' ); ?>">
				<?php
					...
					if ( function_exists( 'wpb_getImageBySize' ) && function_exists( 'wvc_placeholder_img' ) ) {
						...
						$cd_size = apply_filters( 'snakepit_release_img_size', '400x400' );
						$cd_big_size = apply_filters( 'snakepit_release_img_big_size', '1000x1000' );
						...
						if ( wp_attachment_is_image( $img_id ) ) {
							...
							echo snakepit_kses( $img['thumbnail'] );
		...
		<div class="release-meta-container"><?php
				 ...
				 * Release Meta Hook
				 */
				do_action( 'snakepit_release_meta' );
