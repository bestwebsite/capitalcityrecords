		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'snakepit_post_display_options', array(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'snakepit_product_display_options', array(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'snakepit_event_display_options', array(
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'snakepit_work_display_options', array(
				...
				array(
					...
					'value' => array(
						...
						//esc_html__( 'Flip Box', 'snakepit' ) => 'flip-box',
					),
					'admin_label' => true,
					'dependency' => array(
						'element' => 'work_display',
		...
		//array_merge(
			array(
				...
				array(
					...
					'type' => 'dropdown',
					'value' => array_flip( apply_filters( 'snakepit_release_display_options', array(
						'grid' => esc_html__( 'Grid', 'snakepit' ),
					) ) ),
					'admin_label' => true,
				),
				...
				// array(
				// 	'type' => 'dropdown',
				// 	'heading' => esc_html__( 'Text Alignment', 'snakepit' ),
				...
				// array(
				// 	'type' => 'dropdown',
				// 	'heading' => esc_html__( 'Text Vertical Alignment', 'snakepit' ),
				...
				array(
					'type' => 'wvc_textfield',
					'heading' => esc_html__( 'Include Label', 'snakepit' ),
					'param_name' => 'label_include',
					'description' => esc_html__( 'Enter one or several labels. Paste category slug(s) separated by a comma', 'snakepit' ),
					'placeholder' => esc_html__( 'my-category, other-category', 'snakepit' ),
					'group' => esc_html__( 'Query', 'snakepit' ),
				),
				...
				array(
					'type' => 'wvc_textfield',
					'heading' => esc_html__( 'Exclude Label', 'snakepit' ),
