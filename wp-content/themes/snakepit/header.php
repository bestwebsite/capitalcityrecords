...
<?php
	 ...
	 *
	 * @see in/frontend/hooks.php snakepit_output_top_anchor functions
	 */
	do_action( 'snakepit_body_start' );
...
<div class="site-container">
	<div id="page" class="hfeed site">
		...
		<?php
			 ...
			 * Top bar block hook
			 */
			do_action( 'snakepit_top_bar_block' );
		?>
		<header id="masthead" class="site-header clearfix" itemscope itemtype="http://schema.org/WPHeader">
			...
			<div id="header-content">
				<?php
					 ...
					 */
					do_action( 'snakepit_main_navigation' );
				?>
			</div><!-- #header-content -->
		...
		<div id="main" class="site-main clearfix">
			<?php
				 ...
				 */
				do_action( 'snakepit_main_content_start' );
			?>
			<div class="site-content">
				<?php
					 ...
					 * Hero hook
					 *
					 * @see inc/frontend/hooks.php snakepit_output_hero function
					 */
					do_action( 'snakepit_hero' );
				?>
				<?php
					/**
					 * After header block hook
					 */
					do_action( 'snakepit_after_header_block' );
				?>
